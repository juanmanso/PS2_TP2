...
\graficarPDFa{0 10cm 0 10cm}{graf_ej2_pos}{Posición y error de la misma en función del tiempo.}{fig:2pos}
	\Juan{Checkear ésto}
...
\graficarPDF{graf_ej2_theta}{Valores de los coeficientes de $C^e_b$ en el tiempo.}{fig:2theta}
	...
	\Juan{No me parece necesario poner el gráfico de la velocidad.}
